...
function About() {
    return (
     ...
     <h5 className="about-red-title">we are just getting started!!</h5><br></br>
     <p className="about-inner-text">QuickAsk is a new startup that has every intention of making your life easier.
      ...
      hours in order to appease our new Global Market and Tech Lifestyle</p><br></br>
    
    
     <h5 className="about-red-title"> Many of us have been there, right?</h5><br></br>
