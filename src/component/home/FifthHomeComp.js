          ...
          <div class="home-team">
            <div class="home-members">
              ...
              <p className="home-comment-title">
                QuickAsk has made the hiring process easy! Being able to
                streamline the interview process has been a game-changer for me.
                I love the ability to view multiple candidates in one single
                grid and compare the answers. It is a huge time saver. Great job
                you guys.
              </p>{" "}
              <h3>Caris Gonzalez</h3>
          ...
          <div className="home-team">
            <div class="home-members">
              ...
              <p className="home-comment-title">
                ...
                I don't care to learn a complicated ATS/HR system, I just want
                to have the ability to screen my candidates quickly and
                effectively. QuickAsk provides me with the ability to do just
                that, and can serve as a valuable complement to whatever ATS/HR
